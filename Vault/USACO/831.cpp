...
int main()
{
    ...
    set<char> win1; set<set<char>> win2;
    // process rows
    for (int i = 0; i < 3; i++) {
        set<char> s;
        for (int j = 0; j < 3; j++) {
        ...
        else if (sz(s) == 1) win1.insert(rows[i][0]);
    } 
    ...
    for (int i = 0; i < 3; i++) {
        ...
        else if (sz(s) == 1) win1.insert(rows[0][i]);
    }
    ...
    for (int i = 0; i < 2; i++) {
        if (i == 0) {
            ...
            s.insert(rows[1][1]);
            s.insert(rows[2][2]);
            if (sz(s) == 2) win2.insert(s);
            else if (sz(s) == 1) win1.insert(rows[0][0]);
        } else {
            set<char> s;
            s.insert(rows[0][2]);
            s.insert(rows[1][1]);
            s.insert(rows[2][0]);
            if (sz(s) == 2) win2.insert(s);
            else if (sz(s) == 1) win1.insert(rows[0][2]);
        }
    }

    cout << sz(win1) << endl << sz(win2) << endl;
